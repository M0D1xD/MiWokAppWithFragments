...
/**
 * {@link CatagoryAdapter} is a {@link FragmentPagerAdapter} that can provide the layout for
 * each list item based on a data source which is a list of {@link Dictionary} objects.
 */
public class CatagoryAdapter extends FragmentPagerAdapter {
    ...
    /**
     * Create a new {@link CatagoryAdapter} object.
     *
